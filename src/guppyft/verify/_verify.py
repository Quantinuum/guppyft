...
<<<<<<< HEAD
    impl_num_ancillas: int | None = None,
=======
...
=======
                num_selene_qubits=2 * code_definition.n_logical_qubits,
>>>>>>> main
            )
...
=======
                num_selene_qubits=n_physical_choi_qubits,
>>>>>>> main
            )
        case 2:
...
=======
                num_selene_qubits=4 * code_definition.n_logical_qubits,
>>>>>>> main
            )
