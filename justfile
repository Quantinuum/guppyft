...
[doc("""
  ...
  Pass `--debug` to show warnings and code-cell errors, or `--clean` to remove generated files first.
""")]
[arg("debug", long, value="true")]
[arg("clean", long, value="true")]
build-docs debug="false" clean="false":
...
[arg("debug", long, value="true")]
[arg("clean", long, value="true")]
serve-docs debug="false" clean="false": (build-docs debug clean)
